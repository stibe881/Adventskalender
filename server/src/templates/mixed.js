...
const quiz = (question, options, correctIndex, extra = {}) => ({
  type: "quiz",
  content: { question, options, correctIndex, successMessage: extra.ok || "Richtig!", failMessage: extra.fail || "Leider nicht – versuch es morgen wieder.", prizeText: extra.prize || "", prizeCoins: extra.coins ?? 10 },
});
...
const coins = (coinAmount) => ({ type: "coins", content: { coinAmount } });
...
function kidsMix(year) {
  return [
    ...
    quiz("Wie heißt das Rentier mit der roten Nase?", ["Rudolph", "Donner", "Blitz", "Komet"], 0, { ok: "Genau, Rudolph!", coins: 10 }),
    ...
    quiz("Was hängt man an den Weihnachtsbaum?", ["Socken", "Kugeln", "Teller", "Schuhe"], 1, { ok: "Richtig, bunte Kugeln!", coins: 10 }),
    ...
    coins(30),
    quiz("Wie viele Türchen hat ein Adventskalender?", ["12", "24", "31", "100"], 1, { ok: "Genau, 24!", coins: 10 }),
...
function coupleMix(year) {
  return [
    ...
    quiz("Wie viele Rentiere ziehen den Schlitten des Weihnachtsmanns (mit Rudolph)?", ["6", "8", "9", "12"], 2, { ok: "Neun – Rudolph vorneweg!", coins: 10 }),
    ...
    coins(50),
    quiz("Welches Lied wird an Weihnachten weltweit am häufigsten gespielt?", ["Last Christmas", "Jingle Bells", "All I Want for Christmas Is You", "Stille Nacht"], 2, { ok: "Mariah, natürlich.", coins: 10 }),
    ...
    quiz("Seit wann gibt es den Adventskranz ungefähr?", ["Seit dem Mittelalter", "Seit etwa 1840", "Seit 1920", "Seit 1975"], 1, { ok: "Richtig, um 1840 in Hamburg.", coins: 10 }),
